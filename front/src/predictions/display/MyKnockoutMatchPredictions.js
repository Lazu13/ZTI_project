...
class MyKnockoutMatchPredictions extends Component {
    constructor(props) {
        super(props);
        this.state = {
            predictions: [],
    ...
    loadPredictions(page = 0, size = MATCHES_LIST_SIZE) {
        ...
        promise
            ...
            notification.error({
                message: 'ZTI',
                description: "Cannot get matches"
            })
        });
    }
...
export default withRouter(MyKnockoutMatchPredictions)